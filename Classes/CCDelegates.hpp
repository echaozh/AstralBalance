#ifndef _CC_DELEGATES_HPP_
#define _CC_DELEGATES_HPP_ 1
...
public:
    SingleTouchDelegate(DelegateFor &f, cocos2d::CCTouchDispatcher &toucher)
        : f_(f) {
        retain();
        toucher.addTargetedDelegate(this, 0, true);
    }
